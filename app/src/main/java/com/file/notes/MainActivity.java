...
public class MainActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        if (item.getItemId() == R.id.share) {
            ...
            sendIntent.putExtra(Intent.EXTRA_TEXT, "Hey!! Want to take notes? Try this amazing app now. Link: https://github.com/tmd-samin/note-app" + BuildConfig.APPLICATION_ID);
            ...
            startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://github.com/tmd-samin/note-app" + BuildConfig.APPLICATION_ID)));
    ...
    public void checkPermission(MenuItem item) {
        ...
        PermissionListener permissionListener = new PermissionListener() {
            ...
            public void onPermissionGranted() {
               ...
               Log.d(" ", "Send Email: ");
               String[] TO_EMAILS = {"https://github.com/tmd-samin/note-app"};
               ...
               intent.putExtra(Intent.EXTRA_TEXT, "Hey I've found a Bug/Problem inside your app. \nProblem Explanation: \n");
    ...
    private void aboutDialog(){
        new AlertDialog.Builder(this)
                .setTitle("NOTES")
                .setMessage("Hello user, App made for android studio project ")
